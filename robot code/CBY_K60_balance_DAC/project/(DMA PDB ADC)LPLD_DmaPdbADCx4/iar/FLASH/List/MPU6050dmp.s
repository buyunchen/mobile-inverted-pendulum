///////////////////////////////////////////////////////////////////////////////
//                                                                            /
// IAR ANSI C/C++ Compiler V6.70.2.6274/W32 for ARM     23/Mar/2015  13:44:01 /
// Copyright 1999-2013 IAR Systems AB.                                        /
//                                                                            /
//    Cpu mode     =  thumb                                                   /
//    Endian       =  little                                                  /
//    Source file  =  F:\IMPOARTANT\waiting\CBY_K60\lib\LPLD\DEV\MPU6050dmp.c /
//    Command line =  F:\IMPOARTANT\waiting\CBY_K60\lib\LPLD\DEV\MPU6050dmp.c /
//                     -D LPLD_K60 -lCN "F:\IMPOARTANT\waiting\CBY_K60\projec /
//                    t\(DMA PDB ADC)LPLD_DmaPdbADCx4\iar\FLASH\List\" -lB    /
...
//                    ADC)LPLD_DmaPdbADCx4\iar\FLASH\List\MPU6050dmp.s        /
//                                                                            /
//                                                                            /
///////////////////////////////////////////////////////////////////////////////
...
// F:\IMPOARTANT\waiting\CBY_K60\lib\LPLD\DEV\MPU6050dmp.c
//    1 #include "MPU6050dmp.h"
//    2 
...
//   30   MPU6050_WriteByte(SMPLRT_DIV , 0x07 );
        ...
        MOVS     R0,#+25
        BL       MPU6050_WriteByte
//   31   MPU6050_WriteByte(CONFIG , 0x07 );
        MOVS     R1,#+7
        MOVS     R0,#+26
        BL       MPU6050_WriteByte
//   32   MPU6050_WriteByte(AUX_VDDIO,0x80);
        ...
        MOVS     R0,#+1
        BL       MPU6050_WriteByte
//   33   MPU6050_WriteByte(GYRO_CONFIG , 0x18 );
        MOVS     R1,#+24
        MOVS     R0,#+27
        BL       MPU6050_WriteByte
//   34   MPU6050_WriteByte(ACCEL_CONFIG , 0x01 );
        MOVS     R1,#+1
        MOVS     R0,#+28
        BL       MPU6050_WriteByte
