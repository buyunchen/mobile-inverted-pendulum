...
//                    code\CBY_K60_balance_DAC\lib\LPLD\HW\HW_UART.c          /
//    Command line =  "D:\Buyun\Progress\memristor based control\mcu          /
//                    code\paper code\0.1ms control period\test               /
//                    code\CBY_K60_balance_DAC\lib\LPLD\HW\HW_UART.c" -D      /
...
//                    code\paper code\0.1ms control period\test               /
//                    code\CBY_K60_balance_DAC\project\(DMA PDB               /
//                    ADC)LPLD_DmaPdbADCx4\iar\FLASH\List\HW_UART.s           /
//                                                                            /
//                                                                            /
///////////////////////////////////////////////////////////////////////////////
...
// D:\Buyun\Progress\memristor based control\mcu code\paper code\0.1ms control period\test code\CBY_K60_balance_DAC\lib\LPLD\HW\HW_UART.c
//    1 /**
//    2  * @file HW_UART.c
...
//   68       PORTA->PCR[2] = PORT_PCR_MUX(2); 
        LDR.W    R7,??DataTable11_5  ;; 0x40049008
        MOV      R12,#+512
        STR      R12,[R7, #+0]
...
//   70       PORTA->PCR[14] = PORT_PCR_MUX(3); 
        LDR.W    R7,??DataTable11_6  ;; 0x40049038
        MOV      R12,#+768
        STR      R12,[R7, #+0]
        B.N      ??LPLD_UART_Init_3
//   71     else
...
??LPLD_UART_Init_4:
        LDR.W    R7,??DataTable11_7  ;; 0x4004a044
        MOV      R12,#+768
        STR      R12,[R7, #+0]
//   73     
//   74     if(rx_pin == PTA1)
...
//   75       PORTA->PCR[1] = PORT_PCR_MUX(2); 
        LDR.W    R5,??DataTable11_8  ;; 0x40049004
        MOV      R7,#+512
        STR      R7,[R5, #+0]
...
//   77       PORTA->PCR[15] = PORT_PCR_MUX(3); 
        LDR.W    R5,??DataTable11_9  ;; 0x4004903c
        MOV      R7,#+768
        STR      R7,[R5, #+0]
        B.N      ??LPLD_UART_Init_6
//   78     else
...
??LPLD_UART_Init_7:
        LDR.W    R5,??DataTable11_10  ;; 0x4004a040
        MOV      R7,#+768
        STR      R7,[R5, #+0]
        B.N      ??LPLD_UART_Init_6
//   80   }
...
//   90         PORTE->PCR[0] = PORT_PCR_MUX(3); 
        LDR.W    R7,??DataTable11_12  ;; 0x4004d000
        MOV      R12,#+768
        STR      R12,[R7, #+0]
...
??LPLD_UART_Init_9:
        LDR.W    R7,??DataTable11_13  ;; 0x4004b010
        MOV      R12,#+768
        STR      R12,[R7, #+0]
//   93       
//   94       if(rx_pin == PTE1)
...
//   95         PORTE->PCR[1] = PORT_PCR_MUX(3); 
        LDR.W    R5,??DataTable11_14  ;; 0x4004d004
        MOV      R7,#+768
        STR      R7,[R5, #+0]
        B.N      ??LPLD_UART_Init_6
//   96       else
...
??LPLD_UART_Init_11:
        LDR.W    R5,??DataTable11_15  ;; 0x4004b00c
        MOV      R7,#+768
        STR      R7,[R5, #+0]
        B.N      ??LPLD_UART_Init_6
//   98     }
...
//  107         PORTD->PCR[3] = PORT_PCR_MUX(3); 
        LDR.W    R5,??DataTable11_18  ;; 0x4004c00c
        MOV      R7,#+768
        STR      R7,[R5, #+0]
//  108         PORTD->PCR[2] = PORT_PCR_MUX(3);
        LDR.W    R5,??DataTable11_19  ;; 0x4004c008
        MOV      R7,#+768
        STR      R7,[R5, #+0]
        B.N      ??LPLD_UART_Init_6
//  109       }
...
//  118             PORTE->PCR[4] = PORT_PCR_MUX(3); 
        LDR.W    R7,??DataTable11_21  ;; 0x4004d010
        MOV      R12,#+768
        STR      R12,[R7, #+0]
...
//  120             PORTB->PCR[11] = PORT_PCR_MUX(3); 
        LDR.W    R7,??DataTable11_22  ;; 0x4004a02c
        MOV      R12,#+768
        STR      R12,[R7, #+0]
        B.N      ??LPLD_UART_Init_15
//  121           else 
...
??LPLD_UART_Init_16:
        LDR.W    R7,??DataTable11_23  ;; 0x4004b044
        MOV      R12,#+768
        STR      R12,[R7, #+0]
//  123           
//  124           if(rx_pin == PTE5)
...
//  125             PORTE->PCR[5] = PORT_PCR_MUX(3); 
        LDR.W    R5,??DataTable11_24  ;; 0x4004d014
        MOV      R7,#+768
        STR      R7,[R5, #+0]
        B.N      ??LPLD_UART_Init_6
...
//  127             PORTB->PCR[10] = PORT_PCR_MUX(3); 
        LDR.W    R5,??DataTable11_25  ;; 0x4004a028
        MOV      R7,#+768
        STR      R7,[R5, #+0]
        B.N      ??LPLD_UART_Init_6
//  128           else
...
??LPLD_UART_Init_18:
        LDR.W    R5,??DataTable11_26  ;; 0x4004b040
        MOV      R7,#+768
        STR      R7,[R5, #+0]
        B.N      ??LPLD_UART_Init_6
//  130         }
...
//  139               PORTE->PCR[24] = PORT_PCR_MUX(3); 
        LDR.W    R7,??DataTable11_29  ;; 0x4004d060
        MOV      R12,#+768
        STR      R12,[R7, #+0]
...
??LPLD_UART_Init_20:
        LDR.W    R7,??DataTable11_30  ;; 0x4004b03c
        MOV      R12,#+768
        STR      R12,[R7, #+0]
//  142             
//  143             if(rx_pin == PTE25)
...
//  144               PORTE->PCR[25] = PORT_PCR_MUX(3); 
        LDR.W    R5,??DataTable11_31  ;; 0x4004d064
        MOV      R7,#+768
        STR      R7,[R5, #+0]
        B.N      ??LPLD_UART_Init_6
//  145             else
...
??LPLD_UART_Init_22:
        LDR.W    R5,??DataTable11_32  ;; 0x4004b038
        MOV      R7,#+768
        STR      R7,[R5, #+0]
        B.N      ??LPLD_UART_Init_6
//  147           }
...
//  155               PORTD->PCR[9] = PORT_PCR_MUX(3); 
        LDR.W    R7,??DataTable11_34  ;; 0x4004c024
        MOV      R12,#+768
        STR      R12,[R7, #+0]
...
??LPLD_UART_Init_23:
        LDR.W    R7,??DataTable11_35  ;; 0x4004d020
        MOV      R12,#+768
        STR      R12,[R7, #+0]
//  158             
//  159             if(rx_pin == PTD8)
...
//  160               PORTD->PCR[8] = PORT_PCR_MUX(3); 
        LDR.W    R5,??DataTable11_36  ;; 0x4004c020
        MOV      R7,#+768
        STR      R7,[R5, #+0]
        B.N      ??LPLD_UART_Init_6
//  161             else
...
??LPLD_UART_Init_25:
        LDR.W    R5,??DataTable11_37  ;; 0x4004d024
        MOV      R7,#+768
        STR      R7,[R5, #+0]
//  163           }
//  164         }
...
//  406   if((UART0->S1 & UART_S1_RDRF_MASK) && (UART0->C2 & UART_C2_RIE_MASK))
        LDR.N    R0,??DataTable11_40  ;; 0x4006a004
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
        BPL.N    ??UART0_IRQHandler_0
        LDR.N    R0,??DataTable11_41  ;; 0x4006a003
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
        BPL.N    ??UART0_IRQHandler_0
//  407   {
...
//  432   if((UART1->S1 & UART_S1_RDRF_MASK) && (UART1->C2 & UART_C2_RIE_MASK))
        LDR.N    R0,??DataTable11_42  ;; 0x4006b004
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
        BPL.N    ??UART1_IRQHandler_0
        LDR.N    R0,??DataTable11_43  ;; 0x4006b003
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
        BPL.N    ??UART1_IRQHandler_0
//  433   {
...
//  458   if((UART2->S1 & UART_S1_RDRF_MASK) && (UART2->C2 & UART_C2_RIE_MASK))
        LDR.N    R0,??DataTable11_44  ;; 0x4006c004
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
        BPL.N    ??UART2_IRQHandler_0
        LDR.N    R0,??DataTable11_45  ;; 0x4006c003
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
        BPL.N    ??UART2_IRQHandler_0
//  459   {
...
//  484   if((UART3->S1 & UART_S1_RDRF_MASK) && (UART3->C2 & UART_C2_RIE_MASK))
        LDR.N    R0,??DataTable11_46  ;; 0x4006d004
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
        BPL.N    ??UART3_IRQHandler_0
        LDR.N    R0,??DataTable11_47  ;; 0x4006d003
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
        BPL.N    ??UART3_IRQHandler_0
//  485   {
...
//  510   if((UART4->S1 & UART_S1_RDRF_MASK) && (UART4->C2 & UART_C2_RIE_MASK))
        LDR.N    R0,??DataTable11_48  ;; 0x400ea004
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
        BPL.N    ??UART4_IRQHandler_0
        LDR.N    R0,??DataTable11_49  ;; 0x400ea003
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
        BPL.N    ??UART4_IRQHandler_0
//  511   {
...
//  536   if((UART5->S1 & UART_S1_RDRF_MASK) && (UART5->C2 & UART_C2_RIE_MASK))
        LDR.N    R0,??DataTable11_50  ;; 0x400eb004
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
        BPL.N    ??UART5_IRQHandler_0
        LDR.N    R0,??DataTable11_51  ;; 0x400eb003
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
        BPL.N    ??UART5_IRQHandler_0
//  537   {
...
//  550 
        ...
        SECTION `.text`:CODE:NOROOT(1)
        THUMB
//  551 unsigned short CRC_CHECK(unsigned char *Buf, unsigned char CRC_CNT)
//  552 {
CRC_CHECK:
        PUSH     {R4,R5}
//  553     unsigned short CRC_Temp;
//  554     unsigned char i,j;
//  555     CRC_Temp = 0xffff;
        MOVW     R2,#+65535
//  556 
//  557     for (i=0;i<CRC_CNT; i++){      
        MOVS     R3,#+0
        B.N      ??CRC_CHECK_0
??CRC_CHECK_1:
        ADDS     R3,R3,#+1
...
//  559         for (j=0;j<8;j++) {
        MOVS     R4,#+0
        B.N      ??CRC_CHECK_3
//  560             if (CRC_Temp & 0x01)
//  561                 CRC_Temp = (CRC_Temp >>1 ) ^ 0xa001;
//  562             else
//  563                 CRC_Temp = CRC_Temp >> 1;
??CRC_CHECK_4:
...
//  571   int temp[4] = {0};
        ...
        MOVS     R1,#+16
        BL       __aeabi_memclr4
//  572   unsigned int temp1[4] = {0};
        ADD      R0,SP,#+12
        MOVS     R1,#+16
        BL       __aeabi_memclr4
//  573   unsigned char databuf[10] = {0};
        ADD      R0,SP,#+0
        MOVS     R1,#+0
        MOVS     R2,#+0
        MOVS     R3,#+0
...
??OutPut_Data_1:
        ...
        LDR      R1,[R1, R4, LSL #+2]
        STR      R1,[R0, R4, LSL #+2]
//  580     temp1[i] = (unsigned int)temp[i];
        UXTB     R4,R4            ;; ZeroExt  R4,R4,#+24,#+24
        ADD      R0,SP,#+12
        UXTB     R4,R4            ;; ZeroExt  R4,R4,#+24,#+24
        ADD      R1,SP,#+28
...
//  584   for(i=0;i<4;i++) 
        ...
        B.N      ??OutPut_Data_2
//  585   {
//  586     databuf[i*2]   = (unsigned char)(temp1[i]%256);
??OutPut_Data_3:
        UXTB     R4,R4            ;; ZeroExt  R4,R4,#+24,#+24
        ADD      R0,SP,#+12
        LDR      R0,[R0, R4, LSL #+2]
        ...
        ADD      R0,SP,#+0
        STRB     R2,[R0, R4, LSL #+1]
//  587     databuf[i*2+1] = (unsigned char)(temp1[i]/256);
        UXTB     R4,R4            ;; ZeroExt  R4,R4,#+24,#+24
        ADD      R0,SP,#+12
        LDR      R0,[R0, R4, LSL #+2]
        LSRS     R0,R0,#+8
...
??OutPut_Data_2:
        ...
        BLT.N    ??OutPut_Data_3
//  589   
//  590   CRC16 = CRC_CHECK(databuf,8);
        MOVS     R1,#+8
        ADD      R0,SP,#+0
        BL       CRC_CHECK
//  591   databuf[8] = CRC16%256;
        UXTH     R0,R0            ;; ZeroExt  R0,R0,#+16,#+16
        MOV      R1,#+256
        SDIV     R2,R0,R1
        MLS      R2,R2,R1,R0
        STRB     R2,[SP, #+8]
//  592   databuf[9] = CRC16/256;
        UXTH     R0,R0            ;; ZeroExt  R0,R0,#+16,#+16
        MOV      R1,#+256
        SDIV     R0,R0,R1
        STRB     R0,[SP, #+9]
...
//  594   for(i=0;i<10;i++)
        MOVS     R4,#+0
        B.N      ??OutPut_Data_4
//  595   //uart_putchar(databuf[i]);
//  596   LPLD_UART_PutChar(UART0,databuf[i]);
??OutPut_Data_5:
        UXTB     R4,R4            ;; ZeroExt  R4,R4,#+24,#+24
        ADD      R0,SP,#+0
        LDRSB    R1,[R4, R0]
        SXTB     R1,R1            ;; SignExt  R1,R1,#+24,#+24
        LDR.N    R0,??DataTable11_2  ;; 0x4006a000
        BL       LPLD_UART_PutChar
        ADDS     R4,R4,#+1
??OutPut_Data_4:
        UXTB     R4,R4            ;; ZeroExt  R4,R4,#+24,#+24
