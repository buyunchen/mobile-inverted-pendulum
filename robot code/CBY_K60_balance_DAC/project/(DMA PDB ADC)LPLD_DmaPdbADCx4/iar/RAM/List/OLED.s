...
//    Cpu mode     =  thumb                                                   /
//    Endian       =  little                                                  /
//    Source file  =  C:\Users\ChenBuyun\Desktop\CBY_K60\lib\LPLD\DEV\OLED.c  /
//    Command line =  C:\Users\ChenBuyun\Desktop\CBY_K60\lib\LPLD\DEV\OLED.c  /
...
//                    ADC)LPLD_DmaPdbADCx4\iar\RAM\List\OLED.s                /
//                                                                            /
//                                                                            /
///////////////////////////////////////////////////////////////////////////////
...
// C:\Users\ChenBuyun\Desktop\CBY_K60\lib\LPLD\DEV\OLED.c
//    1 /********************************************************   
...
//  327   //LCD_CS=0;;
//  328   DC_OUT = 1;
        LDR.W    R2,??DataTable7  ;; 0x43fe2068
        MOVS     R3,#+1
        STR      R3,[R2, #+0]
//  329   asm("nop"); 
        nop
//  330   D0_OUT = 0;
        LDR.W    R2,??DataTable7_1  ;; 0x43fe1048
        MOVS     R3,#+0
        STR      R3,[R2, #+0]
//  331   asm("nop");    
        nop
...
//  337       D1_OUT = 0;
??LCD_WrDat_1:
        LDR.W    R2,??DataTable7_2  ;; 0x43fe1044
        MOVS     R3,#+0
        STR      R3,[R2, #+0]
//  338     D0_OUT = 1;
??LCD_WrDat_2:
...
//  447   */
//  448   D0_OUT=1;
        LDR.W    R0,??DataTable7_1  ;; 0x43fe1048
        MOVS     R1,#+1
        STR      R1,[R0, #+0]
//  449   D0_OUT=0;
        LDR.W    R0,??DataTable7_1  ;; 0x43fe1048
        ...
        STR      R1,[R0, #+0]
//  450   D1_OUT=1;
        LDR.W    R0,??DataTable7_2  ;; 0x43fe1044
        MOVS     R1,#+1
        STR      R1,[R0, #+0]
//  451   D1_OUT=0;
        LDR.W    R0,??DataTable7_2  ;; 0x43fe1044
        ...
        STR      R1,[R0, #+0]
//  452   DC_OUT=1;
        LDR.W    R0,??DataTable7  ;; 0x43fe2068
        MOVS     R1,#+1
        STR      R1,[R0, #+0]
//  453   DC_OUT=0;
        LDR.W    R0,??DataTable7  ;; 0x43fe2068
        ...
        STR      R1,[R0, #+0]
//  454   RST_OUT=1;
        LDR.W    R0,??DataTable7_3  ;; 0x43fe1040
        MOVS     R1,#+1
        STR      R1,[R0, #+0]
//  455   RST_OUT=0;
        LDR.W    R0,??DataTable7_3  ;; 0x43fe1040
